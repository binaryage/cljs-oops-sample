...
(log (pr-str (oset! o "k1" "v1+")))                                                                                           ; basic form works like `aset`
; => #js {:k1 "v1+", :k2 #js {:k21 "v21"}}

(log (pr-str (oset! o "k2.k21" "new")))                                                                                       ; but you can use dots!
; => #js {:k1 "v1+", :k2 #js {:k21 "new"}}
...
; => #js {:k1 "v1+", :k2 #js {:k21 "new"}}                                                                                    ; and unmodified object back

(log (pr-str (oset! o "k2.!k22.!k221" "v221")))                                                                               ; you have to do explicit punching with !
; => #js {:k1 "v1+", :k2 #js {:k21 "new", :k22 #js {:k221 "v221"}}}
